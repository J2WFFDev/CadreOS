      ...
      <section className="space-y-4">
        ...
        <div className="rounded-lg border border-amber-300 bg-amber-50 p-4 dark:border-amber-700 dark:bg-amber-950/40">
          <p className="text-sm text-amber-900 dark:text-amber-200">
            {scope.errorMessage ?? "Unable to load note creation right now."}
          </p>
        </div>
      </section>
    );
  ...
  if (!people || !teams || !events) {
    return (
      <section className="space-y-4">
        ...
        <div className="rounded-lg border border-amber-300 bg-amber-50 p-4 dark:border-amber-700 dark:bg-amber-950/40">
          <p className="text-sm text-amber-900 dark:text-amber-200">
            Unable to load people, teams, and events right now. Please try again later.
          </p>
        </div>
      </section>
    );
    ...
    <section className="space-y-4">
      ...
      <form action="/notes/create" method="post" className="space-y-4 rounded-lg border bg-white p-4 dark:bg-zinc-900">
        ...
        <div className="flex gap-3">
          ...
          <Link href="/notes" className="rounded-md border px-4 py-2 text-sm">
            Cancel
          </Link>
        </div>
      </form>
