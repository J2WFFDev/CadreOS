...
export const ENTRY_ACTIVITY_ACTIONS = {
  ...
  GEAR_TASK_CREATED: "gear.task_created",
  GEAR_TASK_LINKED: "gear.task_linked",
  GEAR_TASK_COMPLETED: "gear.task_completed",
  GEAR_ITEM_RETURNED_TO_SERVICE: "gear.item_returned_to_service",
  ...
  JOURNAL_RESTORED: "journal.restored",
