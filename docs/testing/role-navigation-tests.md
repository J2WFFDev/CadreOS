...
### Admin
- Expected visible groups: Home, MemberOps, WorkOps, FieldOps / ResourceOps, GearOps, Admin
...
### Coach
- Expected visible groups: Home, MemberOps, WorkOps, FieldOps / ResourceOps, GearOps
...
### Assistant Coach
- Expected visible groups: Home, WorkOps, FieldOps / ResourceOps, GearOps
...
### Guardian
- Expected visible groups: Home, WorkOps, GearOps
...
- Expected hidden groups: MemberOps, WorkOps, FieldOps / ResourceOps, GearOps, Admin
- Expected allowed actions: none (read-only experience)
- Expected blocked actions: all staff mutations
